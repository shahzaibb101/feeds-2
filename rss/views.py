...
def dashboard(request):
    if request.method == 'POST':
        ...
        # summary = 'opera house celebrates 30 years'
        ...
        return render(request, "dashboard.html", {'sentiment': sentiment, 'secondary_text': secondary_text, 'feed': feed, 'author_name': author_name, 'author_email': author_email})
    else:
